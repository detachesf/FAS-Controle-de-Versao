...
!define COMPANY "DSC (DEPARTAMENTO DE ENGENRARIA DE SISTEMAS DE CONTROLE DE USINAS E SUBESTAÇÕES)"
!define URL "http://intranet.chesf.gov.br/DE/SPT/DSC/SitePages/FAS.aspx"
...
Section "!Instalar FAS" SEC0000
    ...
    File LP_Config.xls
    File "Padrao Planilha Supervisao_rev1M.xlsm"
	File "Considerações Técnicas N1 e N2 R04.pdf"
...
Section "Instalar Python 3.4.4, xlrd e xlsxwriter" SEC0001
	...
	# Copiar XlsxWriter e xlrd para Python 3.4
...
Section /o "-un.Instalar FAS" UNSEC0000
    ...
    Delete /REBOOTOK "$INSTDIR\Padrão Planilha Supervisão_rev1L.xls"
	Delete /REBOOTOK "$INSTDIR\Considerações Técnicas N1 e N2 R04.pdf"
