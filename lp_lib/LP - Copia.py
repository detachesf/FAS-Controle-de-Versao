                        ...
                        if sheet.name == 'SD':
                            ...
                            for parametros_LT in conf_LT_array:
                                ...
                                if cd1 * cd2 * cd3 * cd4 * cd5 * cd6 * cd7 * cd8 * cd9 * cd10 * cd11 * cd12 * cd13:
                                    ...
                                    elif 'FCOn' in tratar_1:
                                        for n_canal in range(1, 3):
                                            texto_canal = tratar_1[tratar_1.find('FCOn'):-1] + str(n_canal)
                                            tratar_2 = tratar_1.replace('FCOn', texto_canal)
                                            gravar_ponto(tratar_2, descricao_1)
                                            k_lt += 1

                                    elif 'PFCn' in tratar_1:
                                        for n_canal in range(1, 3):
                                            texto_canal = tratar_1[tratar_1.find('PFCn'):-1] + str(n_canal)
                                            tratar_2 = tratar_1.replace('PFCn', texto_canal)
                                            gravar_ponto(tratar_2, descricao_1)
                                            k_lt += 1
                                    else:
                                        ...
                                        if sheet.cell(index_linha, titulo_dic[
                                            ...
                                            if parametros_87B['ARR'] != 'DISJ E MEIO':
                                                if tratar[4:10] == '0XB1/2':  # Ponto Agrupado de Barra1 e Barra 2
                                                    ...
                                                    if 'FCOn' in tratar_1:
                                                        for n_canal in range(1, 3):
                                                            texto_canal = tratar_1[tratar_1.find('FCOn'):-1] + str(
                                                                n_canal)
                                                            tratar_2 = tratar_1.replace('FCOn', texto_canal)
                                                            gravar_ponto(tratar_2, descricao_1)
                                                            k_barra += 1
                            ...
                            for parametros_vao in parametros:
                                ...
                                for arranjo in arr:
                                    ...
                                    if parametros_vao.get('PASSSecc', [None])[0] and (
                                                    'FTCO' in tratar or 'FCAM' in tratar):
